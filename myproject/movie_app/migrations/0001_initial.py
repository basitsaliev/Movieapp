# Generated by Django 5.2.7 on 2025-10-26 07:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pro', 'pro'), ('simle', 'simle')], default='simple')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_movie', models.CharField(choices=[('pro', 'pro'), ('simle', 'simle')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('favorite_movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_movie', to='movie_app.movie')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_movie', to='movie_app.movie')),
            ],
        ),
        migrations.CreateModel(
            name='MovieLanguages',
